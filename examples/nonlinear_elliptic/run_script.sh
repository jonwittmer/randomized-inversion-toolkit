...
python nonlinear_AD_script.py --strategy enkf --n_random_vectors 10 | tee -a output.o
python nonlinear_AD_script.py --strategy enkf --n_random_vectors 100 | tee -a output.o
python nonlinear_AD_script.py --strategy enkf --n_random_vectors 1000 | tee -a output.o
#python nonlinear_AD_script.py --strategy enkf --n_random_vectors 10000 | tee -a output.o

python nonlinear_AD_script.py --strategy all --n_random_vectors 10 | tee -a output.o
python nonlinear_AD_script.py --strategy all --n_random_vectors 100 | tee -a output.o
python nonlinear_AD_script.py --strategy all --n_random_vectors 1000 | tee -a output.o
